 ...
 */
public class NfcCardsActivity extends BaseActivity implements BizCardAdapter.OnClickListener {
    ...
    private android.content.Loader<List<BusinessCardPopulated>> createBizCardLoader() {
        ...
        return new BizCardPopulatedListLoader(NfcCardsActivity.this);
    }
    ...
    private void finishedBizCardLoader(List<BusinessCardPopulated> data) {
        ...
        if (data == null) {
            ...
            Groundy.create(ActionRequestBusinessCardsTask.class)
                    .callback(NfcCardsActivity.this)
                    .callbackManager(mCallbacksManager)
                    .queueUsing(NfcCardsActivity.this);
        } else {
