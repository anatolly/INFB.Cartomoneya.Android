...
import com.intrafab.cartomoneya.actions.ActionRequestLoginTask;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onSuccessRequestLogin(
            ...
            @Param(Constants.Extras.PARAM_USER_DATA) User userAccount) {
        mButtonLogin.setEnabled(true);
        hideProgress();
        AppApplication.setLogin(this, token);
        AppApplication.getApplication(this).setUserInfo(this, mCallbacksManager, userAccount);
    }
